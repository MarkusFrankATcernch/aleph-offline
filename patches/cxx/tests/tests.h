...
namespace alpha  {
  ...
  namespace tests  {
    ...
    /// Verify track-mother and track-daughter relationships
    void print_track_mothers_daughters( bool print, int32_t itk, const char* prefix="Track");
    /// Check links from QVEC to other banks (1)
    void print_charged_track_opts1( bool print, int32_t itk);
    ...
    void print_charged_track_calo( bool print, int32_t itk);
    ...
    void print_mc_track(bool print, int32_t itk);
    ...
    std::size_t access_bank_type(bool print, const std::string& bnam);
    std::size_t access_bank_lists(bool print);
...
extern "C"  {
  ...
  void f77_print_mc_track_(const uint32_t& which );
  ...
  void f77_print_track_mothers_daughters_(const uint32_t& which, const char* pref, int );
  ...
  void f77_print_track_calo_(const uint32_t& itk);
}
